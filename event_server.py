...
class EventServer:
    ...
    def get_ident(self) -> str:
        ...
        try:
            ...
            fid.close()
            for nmbr in self.api_srv.smip.mac.split(":"):
            ...
            try:
                ...
                if prefix[3] == 0:
                    ...
                    if len(tail) == 1:
                        ...
                        # arg_1 = rt_event[7]
                        # arg_2 = rt_event[8]
                        await self.notify_event(rtr_id, rt_event[5:-1])
    ...
    async def notify_event(self, rtr: int, event: bytes):
